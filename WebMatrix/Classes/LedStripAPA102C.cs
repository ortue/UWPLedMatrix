...
//    public LedStripAPA102C(int ledCount = 400, int spiChannel = 0, int spiFrequency = 10000000, bool reverseRgb = true)
//    {
...
//      for (int baseAddress = 0; baseAddress < LedCount * _pixelHolder.Length; baseAddress += _pixelHolder.Length)
//      {
...
//        LedStripPixel pixel = this[index];
//        pixel.R = r;
//        pixel.G = g;
//        pixel.B = b;
...
//    public void SetPixelsBak(List<Couleur> pixels, int sourceOffsetX = 0, int sourceOffsetY = 0, float brightness = 0f, int targetOffset = 0, int targetLength = 0)
//    {
...
//      byte brightnessByte = (byte)(brightness * 31);
...
//        int frameBufferOffset = StartFrame.Length + (targetOffset * StartFrame.Length);


//        foreach (Couleur color in pixels)
//        {
//          _frameBuffer[frameBufferOffset + brightnessOffset] = color.A;
//          _frameBuffer[frameBufferOffset + redOffset] = color.R; // R
//          _frameBuffer[frameBufferOffset + greenOffset] = color.G; // G
//          _frameBuffer[frameBufferOffset + blueOffset] = color.B; // B
//          frameBufferOffset += 4;

//        }


//        //for (int bmpOffset = 0; bmpOffset < pixels.Count; bmpOffset++)
//        //{
//        //  _frameBuffer[frameBufferOffset + brightnessOffset] = brightnessByte;
//        //  _frameBuffer[frameBufferOffset + redOffset] = pixels[bmpOffset].R; // R
//        //  _frameBuffer[frameBufferOffset + greenOffset] = pixels[bmpOffset].G; // G
//        //  _frameBuffer[frameBufferOffset + blueOffset] = pixels[bmpOffset].B; // B
...
//          byte brightnessByte = (byte)(value * 31);
...
//      public byte R
//      {
//        get { return _owner.ReverseRgb ? _owner._frameBuffer[_baseAddress + 3] : _owner._frameBuffer[_baseAddress + 1]; }
...
//      public byte G
//      {
//        get { return _owner._frameBuffer[_baseAddress + 2]; }
...
//      public byte B
//      {
//        get { return _owner.ReverseRgb ? _owner._frameBuffer[_baseAddress + 1] : _owner._frameBuffer[_baseAddress + 3]; }
//        set
//        {
//          if (_owner.ReverseRgb)
//            _owner._frameBuffer[_baseAddress + 1] = value;
